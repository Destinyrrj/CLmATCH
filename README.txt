Для запуска на Windows нужно запустить exe файл из папки Windows.

Для запуска на Linux нужно запустить исполняемый файл из папки Linux.
...
Для запуска из исходников нужно :
